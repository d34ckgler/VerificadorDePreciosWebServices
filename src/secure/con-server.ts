...
module.exports = class mssql {
    ...
    getInvoice(cInvoice: string) {
        ...
        return new Promise(async (rs, rj) => {
            ...
            if (_this._pool == null) return;
            _this.request = new sql.Request(_this._pool);
            _this.request.query(`select ssl.biozonas_id as bz_id, ssl.biosubzonas_id as bsz_id, P.C_Caja, P.C_Numero, P.C_CONCEPTO, P.F_Fecha, P.C_RIF, P.C_DESC_CLIENTE, ssl.N_Telefono, ssl.C_Direccion as cu_direccion_cliente, ssl.C_Email, BR.biozonas_id, BR.biosubzonas_id,
