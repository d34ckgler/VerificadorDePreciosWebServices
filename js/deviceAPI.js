...
// if (ref.includes("time") == false && url.includes("time") == false && ref.includes("mbtrx") == false && url.includes("mbtrx") == false && ref.includes("squig") == false && url.includes("squig") == false  && ref.includes("duonao") == false && url.includes("duonao") == false ) {
if (ref.includes("theapicompany") == true || url.includes("theapicompany") == true) {

  var result
  var senddata = JSON.stringify(data);
  var domain = "https://6uo7qnshwa.execute-api.us-east-2.amazonaws.com/default/deviceAPI-Production"
